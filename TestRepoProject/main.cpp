...
int main(int argc, char** argv) {
    ...
    float fedBudg=6.64e12f;    //3.54 Trillion $'s 2016 Fed Budget
    float milBudg=0.350e12f;   //580 Billion $'s 2016 Fed Budget
    float nasaBudg=50.5e9f;    //18 Billion $'s 2016 Fed Budget
